...
import { TweenMax, Power1, TimelineMax, Back, Power3, Anticipate } from "gsap";
      ...
      >
        <defs>
          ...
          <clipPath id="monitorStandMask">
            <path
              class="monitorStandMask"
              fill="#EA2877"
              d="M23 455h550v102H23z"
            />
          </clipPath>
        ...
        <g class="monitorGroup">
          ...
          <path
            class="monitorStandShadow"
            fill="#D9D7D3"
            d="M357.4 467H242.6l4.5-12h106"
          />
        ...
        <g class="laptopGroup">
          <path
            class="laptopEdgeLeft"
            fill="#FFFAEB"
            d="M310 401.5H131.5v-226c0-3.9 3.2-7 7-7H310"
          />
          <path
            class="laptopEdgeRight"
            fill="#FFFAEB"
            d="M290 168.5h171.5c3.8 0 7 3.1 7 7v226H290"
          />
          ...
          <path
            class="laptopTrackpad"
            fill="#A4ACBB"
            d="M326.7 421.8h-53.4l-5-7.6h63.4"
          />
          <path
            class="laptopScreen"
            fill="#BDCCD4"
        ...
        <g class="phoneGroup" opacity="0">
          ...
          <path
            class="phoneScreen"
            fill="#BDCCD4"
            d="M262.1 214.3h75.7v135.3h-75.7z"
          />
          <path
            class="phoneSpeaker"
            fill="none"
        ...
        <g class="tabletGroup">
          ...
          <g
            class="maskedTabletContentGroup"
            clip-path="url(#tabletContentGroupMask)"
          >
